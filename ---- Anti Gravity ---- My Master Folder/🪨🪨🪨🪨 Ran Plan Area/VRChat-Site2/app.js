...
function renderSidebar() {
  // Update sidebar title with VRChat gradient
  const titleEl = document.querySelector('.wordmark-title');
  if (titleEl) {
    titleEl.innerHTML = '<span class="gradient-text">VRChat Ultimate</span>';
  }
