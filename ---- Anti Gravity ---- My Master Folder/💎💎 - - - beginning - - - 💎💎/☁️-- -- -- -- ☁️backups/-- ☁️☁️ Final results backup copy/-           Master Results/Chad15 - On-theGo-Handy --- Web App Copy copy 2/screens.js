            ...
            <div class="glass-medium active-glow recap-card"
                ...
                <div id="whisper-task-sheet" class="recap-task-rollout" style="position: relative;">
                    <div class="recap-task-row" onclick="app.enterFocusMode('whisper', null, 0, app.whisperData[app.whisperActiveIndex].tasks[0] || '')">
                        ...
                        <div class="task-input-display" style="flex:1; color: white; font-family: 'Outfit'; font-size: 0.85rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 2px 0;">Vision #1</div>
                    </div>
                    <div class="recap-task-row" onclick="app.enterFocusMode('whisper', null, 1, app.whisperData[app.whisperActiveIndex].tasks[1] || '')">
                        <div class="task-dot"></div>
                        <div class="task-input-display" style="flex:1; color: white; font-family: 'Outfit'; font-size: 0.85rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 2px 0;">Vision #2</div>
                    </div>
                    <div class="recap-task-row" onclick="app.enterFocusMode('whisper', null, 2, app.whisperData[app.whisperActiveIndex].tasks[2] || '')">
                        <div class="task-dot"></div>
                        <div class="task-input-display" style="flex:1; color: white; font-family: 'Outfit'; font-size: 0.85rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 2px 0;">Vision #3</div>
                    </div>
                    <div class="recap-task-row" onclick="app.enterFocusMode('whisper', null, 3, app.whisperData[app.whisperActiveIndex].tasks[3] || '')">
                        <div class="task-dot"></div>
                        <div class="task-input-display" style="flex:1; color: white; font-family: 'Outfit'; font-size: 0.85rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 2px 0;">Vision #4</div>
                    </div>
                    <div class="recap-task-row" onclick="app.enterFocusMode('whisper', null, 4, app.whisperData[app.whisperActiveIndex].tasks[4] || '')">
                        <div class="task-dot"></div>
                        <div class="task-input-display" style="flex:1; color: white; font-family: 'Outfit'; font-size: 0.85rem; font-weight: 600; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; padding: 2px 0;">Vision #5</div>
                    </div>
                </div>
            </div>
        </div>
