console.log("Apple Music Parsing Job: Master Content Script Loaded");
let globalArtistId = '';
...
function initBattleCommand() {
    ...
    styleSheet.innerText = `
        ...
        .ios-btn:hover { transform: scale(1.03); opacity: 0.95; box-shadow: 0 10px 20px rgba(250, 45, 72, 0.25); }
        .ios-btn:active { transform: scale(0.97); }
        .ios-btn.secondary { background: rgba(0,0,0,0.05); color: #fa2d48; }
        ...
        #battle-progress-bar {
            height: 100%; width: 0%; background: #fa2d48; transition: width 0.5s ease;
        }
    `;
    ...
    tile.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <h2 style="margin: 0; font-size: 18px; font-weight: 800; letter-spacing: -0.5px;">Apple Music Mode</h2>
            </div>
        ...
        <div style="background: rgba(250, 45, 72, 0.05); padding: 15px; border-radius: 20px; border: 1px solid rgba(250, 45, 72, 0.1); margin: 5px 0;">
            <label style="display: block; font-size: 10px; font-weight: 800; color: #fa2d48; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 6px;">Apple Artist ID Override</label>
    ...
    tile.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; align-items: center; gap: 10px;">
                ...
                <h2 style="margin: 0; font-size: 18px; font-weight: 800; letter-spacing: -0.5px;">Apple Battle</h2>
            </div>
...
async function processCluster(cluster) {
    ...
    try {
        ...
        // Apple Music URLs (Placeholders - need verification of exact Apple dashboard patterns)
        const url24h = `https://artists.apple.com/a/artist/${artistId}/song/${songId}/insights?time=24h`;
        const url12mo = `https://artists.apple.com/a/artist/${artistId}/song/${songId}/insights?time=1y`;
