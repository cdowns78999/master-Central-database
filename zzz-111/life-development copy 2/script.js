document.addEventListener('DOMContentLoaded', () => {
    ...
    function igniteDrone(card, url) {
        ...
        try {
            ...
            } else if (platform === 'tiktok' && u.includes('@')) {
                handle = u.split('@')[1].split(/[?#&]/)[0];
            } else if (['kick', 'twitch', 'github', 'instagram', 'twitter', 'x'].includes(platform)) {
        ...
        screen.innerHTML = `
            <div class="ignition-static" style="position:absolute; inset:0; background:white; opacity:0.8; z-index:15; animation: fadeOut 0.5s forwards; pointer-events: none;"></div>
            <img src="${avatarUrl}" class="profile-thumb" alt="Thumb" 
                 onload="this.style.opacity=1"
                 onerror="this.src='https://www.google.com/s2/favicons?domain=${url}&sz=128'"
                 style="opacity:0; transition: opacity 0.8s ease-in; object-fit: cover; width: 100%; height: 100%;">
