...
// --- MAIN ROUTER ---
// --- DEPRECATED: BLOCKING PROCESS ---
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    console.warn("⚠️ LEGACY BACKGROUND DETECTED. Blocking action:", request.action);
    sendResponse({ success: false, error: "Legacy extension. Use Slot 7 instead." });
    return true;
});
