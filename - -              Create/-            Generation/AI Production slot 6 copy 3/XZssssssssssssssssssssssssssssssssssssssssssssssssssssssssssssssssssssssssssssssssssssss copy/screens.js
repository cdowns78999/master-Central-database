...
<div class="screen-animation-fade" style="padding-top: 10px;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 25px;">
        ...
        <!-- Recap of Call Card -->
        <div class="glass-medium recap-card"
             style="height: 160px; border-radius: var(--radius-md); padding: 18px; position: relative; overflow: hidden; cursor: pointer;"
             onclick="app.toggleRecapDates()">
            <img src="https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=500"
            ...
            <h4 style="position: relative; font-size: 1.1rem; font-family: 'Outfit'; font-weight: 800;">Recap of<br>Call</h4>

            <!-- 4 Date Slots Container -->
            <div id="recap-dates-mount" class="recap-dates-container" style="position: relative; margin-top: 12px;">
                <div class="recap-date-slot">MM/DD</div>
                <div class="recap-date-slot">MM/DD</div>
                <div class="recap-date-slot">MM/DD</div>
                <div class="recap-date-slot">MM/DD</div>
            </div>
