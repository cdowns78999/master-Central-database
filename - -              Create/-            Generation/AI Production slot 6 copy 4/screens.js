...
<div class="screen-animation-fade" style="padding-top: 10px;">
    ...
    <!-- Roadmap Section -->
    <h2 style="font-size: 1.2rem; margin-bottom: 25px; display: flex; align-items: center; gap: 10px; line-height: 1.4;">
        'Live Your Dreams' Road Map <span style="width: 8px; height: 8px; background: var(--accent-pink); border-radius: 50%; box-shadow: 0 0 10px var(--accent-pink);"></span>
    </h2>
    ...
    <div class="glass-medium" style="position: relative; border-radius: var(--radius-lg); overflow: hidden; height: 220px; cursor: pointer;" onclick="app.load('detail')">
        <img src="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?q=80&w=1000" style="width: 100%; height: 100%; object-fit: cover; position: absolute; inset: 0;">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 25px;">
        <div class="glass-medium" style="height: 160px; border-radius: var(--radius-md); padding: 18px; position: relative; overflow: hidden;">
            <img src="https://images.unsplash.com/photo-1493225255756-d9584f8606e9?q=80&w=500" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover;">
            <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(26, 11, 46, 0.8) 0%, rgba(75, 76, 237, 0.4) 100%);"></div>
        ...
        <div class="glass-medium" style="height: 160px; border-radius: var(--radius-md); padding: 18px; position: relative; overflow: hidden;">
            <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?q=80&w=500" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover;">
            <div style="position: absolute; inset: 0; background: linear-gradient(135deg, rgba(26, 11, 46, 0.8) 0%, rgba(255, 0, 222, 0.4) 100%);"></div>
            <h4 style="position: relative; font-size: 1.1rem; font-family: 'Outfit';">Live<br>Sessions</h4>
