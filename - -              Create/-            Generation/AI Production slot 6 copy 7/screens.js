        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
            ...
            <div id="whisper-task-sheet" class="recap-task-rollout">
                <div class="recap-task-row">
                    ...
                    <input type="text" placeholder="Focus item..." class="task-input" oninput="app.saveWhisperTask(0, this.value)">
                </div>
                <div class="recap-task-row">
                    <div class="task-dot"></div>
                    <input type="text" placeholder="Next priority..." class="task-input" oninput="app.saveWhisperTask(1, this.value)">
                </div>
                <div class="recap-task-row">
                    <div class="task-dot"></div>
                    <input type="text" placeholder="Action item..." class="task-input" oninput="app.saveWhisperTask(2, this.value)">
                </div>
            </div>
        </div>
    </div>
