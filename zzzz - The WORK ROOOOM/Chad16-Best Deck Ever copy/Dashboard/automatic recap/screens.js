const SCREENS = {
    ...
    <div class="screen-animation-fade" style="padding-top: 30px;">
        <h1 class="editable-title" contenteditable="true" onblur="app.saveTitle('main', this.innerText)" style="font-size: 2.4rem; font-family: 'Outfit'; margin-bottom: 35px; line-height: 1.2; letter-spacing: -0.5px;">
            'Live Your Dreams'<br>Road Map <span class="command-trigger" onclick="event.stopPropagation(); app.toggleCommandConsole()" style="display: inline-block; width: 10px; height: 10px; background: var(--accent-pink); border-radius: 50%; box-shadow: 0 0 15px var(--accent-pink); margin-left: 5px; cursor: pointer; transition: all 0.3s ease;"></span>
        </h1>

        <!-- 🏗️ COMMAND CENTER (Hidden by default) -->
        <div class="command-center" id="command-console">
            <div class="command-header">
                <h4 style="font-size: 0.8rem; color: var(--accent-cyan); text-transform: uppercase; letter-spacing: 1px;">Command Console</h4>
