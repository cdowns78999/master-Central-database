    ...
    <div class="screen-animation-fade" style="padding-top: 30px;">
        ...
        <div class="command-center">
            ...
            <div class="command-controls">
                <select id="target-selection" class="command-select">
                    <option value="recap">Target: Recap Card</option>
                    <option value="weekly">Target: Weekly Vision</option>
                </select>
                ...
                <div style="display: flex; gap: 20px; margin-left: auto; align-items: center;">
                    ...
                    <button class="btn-clear" onclick="app.clearAllCards()">CLEAR ALL</button>
                </div>
            </div>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px;">
                <div class="glass-medium active-glow recap-card" id="recap-main-card" style="min-height: 140px; border-radius: var(--radius-md); padding: 16px; position: relative; overflow: hidden; cursor: pointer;" onclick="app.toggleWhisperSheet()">
                    ...
                    <div style="position: relative; display: flex; justify-content: space-between; align-items: flex-start;">
                        <h4 class="editable-title" contenteditable="true" onblur="app.saveTitle('recap', this.innerText)" style="font-size: 1.1rem; color: white;">Recap of<br>Call</h4>
